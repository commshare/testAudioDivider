...
typedef struct TGlobalState
{
	...
	LPWSTR strDefaultDeviceID; //默认设备的id
...
{
	//fix Now non-english characters displayed correctly without "???". or https://github.com/DanStevens/AudioEndPointController/pull/2/commits/69245f44f2aac67472b352da7dc7349bbb935964
	setlocale(LC_ALL, "");
	TGlobalState state;
...
//这个是我加的
HRESULT SetDefaultAudioPlaybackDeviceWin7(LPCWSTR devID)
{
